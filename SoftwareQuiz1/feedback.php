...
<div class="col-md-10">
<a href="mailto:chiraggoel.53784@gmail.com" style="color:#000000">Kuldeep.2019@vitstudent.ac.in</a><br /><br />
...
<div class="modal fade title1" id="developers">
  <div class="modal-dialog">
    ...
    <div class="row">
    <div class="col-md-4">
     <img src="image/CAM00120.jpg" width=150 height=200 alt="Kuldeep" class="img-rounded">
     </div>
     <div class="col-md-5">
    <a href="http://yugeshverma.blogspot.in" style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on Facebook">Kuldeep Sdk</a>
