...
<title>Vit Online Exam Portal || DASHBOARD </title>
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul style="display: inline" class="nav navbar-nav">
        <li style="display: inline" <?php if(@$_GET['q']==0) echo'class="active"'; ?>><a href="dash.php?q=0">Home</a></li>
        <li style="display: inline" <?php if(@$_GET['q']==1) echo'class="active"'; ?>><a href="dash.php?q=1">User</a></li>
